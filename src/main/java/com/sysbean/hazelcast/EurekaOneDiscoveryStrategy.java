...
import com.sysbean.hazelcast.config.PropertyBasedEurekaClientConfig;
...
final class EurekaOneDiscoveryStrategy extends AbstractDiscoveryStrategy {
    ...
    public Iterable<DiscoveryNode> discoverNodes() {
        ...
        String appGroupName = applicationInfoManager.getEurekaInstanceConfig().getAppGroupName();
        List<Application> registeredApplications = eurekaClient.getApplications().getRegisteredApplications();

        for(Application registeredApplication: registeredApplications) {
            List<InstanceInfo> instances = registeredApplication.getInstancesAsIsFromEureka();
